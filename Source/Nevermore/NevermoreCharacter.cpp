...
ANevermoreCharacter::ANevermoreCharacter()
{
...
void ANevermoreCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANevermoreCharacter::Move);
...
void ANevermoreCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANevermoreCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
